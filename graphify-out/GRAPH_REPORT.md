...
- Token cost: 6,200 input · 1,900 output

## Community Hubs (Navigation)
- [[_COMMUNITY_PLC Engine Core|PLC Engine Core]]
- [[_COMMUNITY_FBD Editor|FBD Editor]]
- [[_COMMUNITY_LAD Editor|LAD Editor]]
- [[_COMMUNITY_Cyclic Scan Simulator|Cyclic Scan Simulator]]
- [[_COMMUNITY_App Architecture & Core|App Architecture & Core]]
- [[_COMMUNITY_Python Code Generator|Python Code Generator]]
- [[_COMMUNITY_Pi HTTP Runtime Server|Pi HTTP Runtime Server]]
- [[_COMMUNITY_App Bootstrap & Tabs|App Bootstrap & Tabs]]
- [[_COMMUNITY_Project Tree UI|Project Tree UI]]
- [[_COMMUNITY_Toolbar & Ribbon|Toolbar & Ribbon]]
- [[_COMMUNITY_Tags Outline Panel|Tags Outline Panel]]
- [[_COMMUNITY_GPIO Backend & Mock|GPIO Backend & Mock]]
- [[_COMMUNITY_Block Interface Editor|Block Interface Editor]]
- [[_COMMUNITY_PLC Tags Table|PLC Tags Table]]
- [[_COMMUNITY_Details View|Details View]]
- [[_COMMUNITY_Online Pi Monitor|Online Pi Monitor]]
- [[_COMMUNITY_Shell Launcher|Shell Launcher]]
...
- `CLAUDE.md — Contributor / Agent Guide` --semantically_similar_to--> `SPEC.md — Module Interface Contract`  [INFERRED] [semantically similar]
  CLAUDE.md → SPEC.md
- `Engine` --uses--> `Handler`  [INFERRED]
  plc_engine.py → plc_server.py
- `Engine` --uses--> `Runtime`  [INFERRED]
  plc_engine.py → plc_server.py
...
### Community 4 - "App Architecture & Core"
Cohesion: 0.06
...
### Community 6 - "Pi HTTP Runtime Server"
Cohesion: 0.10
...
### Community 11 - "GPIO Backend & Mock"
Cohesion: 0.19
...
- **Why does `index.html — App Entry Point` connect `App Architecture & Core` to `FBD Editor`, `LAD Editor`, `Cyclic Scan Simulator`, `Python Code Generator`, `App Bootstrap & Tabs`, `Project Tree UI`, `Toolbar & Ribbon`, `Tags Outline Panel`, `Block Interface Editor`, `PLC Tags Table`, `Details View`, `Online Pi Monitor`?**
  _High betweenness centrality (0.337) - this node is a cross-community bridge._
- **Why does `CLAUDE.md — Contributor / Agent Guide` connect `App Architecture & Core` to `FBD Editor`, `LAD Editor`, `Cyclic Scan Simulator`, `App Bootstrap & Tabs`, `Toolbar & Ribbon`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `T.bus — Cross-Module Event Bus (on/off/emit)` connect `App Architecture & Core` to `FBD Editor`, `LAD Editor`, `Cyclic Scan Simulator`?**
...
- **Should `PLC Engine Core` be split into smaller, more focused modules?**
